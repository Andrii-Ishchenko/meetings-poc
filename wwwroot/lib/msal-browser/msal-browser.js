    ...
    ***************************************************************************** */
    ...
    var Credential = /** @class */ (function () {
        ...
        Credential.prototype.generateCredentialId = function () {
            var clientOrFamilyId = CredentialType.REFRESH_TOKEN
    ...
    var UnifiedCacheManager = /** @class */ (function () {
        ...
        UnifiedCacheManager.prototype.getAccount = function (key) {
            var account = this.cacheStorage.getItem(key, CacheSchemaType.ACCOUNT, this.inMemory);
            return account;
        };
        /**
        ...
        UnifiedCacheManager.prototype.getCredential = function (key) {
            return this.cacheStorage.getItem(key, CacheSchemaType.CREDENTIAL, this.inMemory);
        };
        /**
        ...
        UnifiedCacheManager.prototype.getAccountsFilteredByInternal = function (homeAccountId, environment, realm) {
            ...
            allCacheKeys.forEach(function (cacheKey) {
                ...
                var entity = _this.cacheStorage.getItem(cacheKey, CacheSchemaType.ACCOUNT);
        ...
        UnifiedCacheManager.prototype.getCredentialsFilteredByInternal = function (homeAccountId, environment, credentialType, clientId, realm, target) {
            ...
            allCacheKeys.forEach(function (cacheKey) {
                ...
                var entity = _this.cacheStorage.getItem(cacheKey, CacheSchemaType.CREDENTIAL);
                if (!StringUtils.isEmpty(homeAccountId)) {
                    matches = CacheHelper.matchHomeAccountId(entity, homeAccountId);
                }
                if (!StringUtils.isEmpty(environment)) {
        ...
        UnifiedCacheManager.prototype.removeAccount = function (accountKey) {
            ...
            return (this.removeAccountContext(account) &&
                this.cacheStorage.removeItem(accountKey, CacheSchemaType.ACCOUNT, this.inMemory));
        };
        /**
         * returns a boolean if the given account is removed
         * @param account
        ...
        UnifiedCacheManager.prototype.removeAccountContext = function (account) {
            ...
            allCacheKeys.forEach(function (cacheKey) {
                ...
                var cacheEntity = _this.cacheStorage.getItem(cacheKey, CacheSchemaType.CREDENTIAL, _this.inMemory);
                if (!!cacheEntity &&
    ...
    var AdfsAuthority = /** @class */ (function (_super) {
        __extends$1(AdfsAuthority, _super);
    ...
    */
    ...
    var SPAClient = /** @class */ (function (_super) {
        ...
        SPAClient.prototype.fetchIdToken = function (homeAccountId, environment, inputRealm) {
            var idTokenKey = CacheHelper.generateCredentialCacheKey(homeAccountId, environment, CredentialType.ID_TOKEN, this.config.authOptions.clientId, inputRealm);
        ...
        SPAClient.prototype.fetchRefreshToken = function (homeAccountId, environment) {
            var refreshTokenKey = CacheHelper.generateCredentialCacheKey(homeAccountId, environment, CredentialType.REFRESH_TOKEN, this.config.authOptions.clientId);
    ...
    var BrowserStorage = /** @class */ (function () {
        ...
        BrowserStorage.prototype.getItem = function (key, type) {
            ...
            switch (type) {
                case CacheSchemaType.ACCOUNT: {
                    var account = new AccountEntity();
                    return CacheHelper.toObject(account, JSON.parse(value));
                }
                case CacheSchemaType.CREDENTIAL: {
                    var credentialType = CacheHelper.getCredentialType(key);
                    switch (credentialType) {
                        case CredentialType.ID_TOKEN: {
                            var idTokenEntity = new IdTokenEntity();
                            return CacheHelper.toObject(idTokenEntity, JSON.parse(value));
                        }
                        case CredentialType.ACCESS_TOKEN: {
                            var accessTokenEntity = new AccessTokenEntity();
                            return CacheHelper.toObject(accessTokenEntity, JSON.parse(value));
                        }
                        case CredentialType.REFRESH_TOKEN: {
                            var refreshTokenEntity = new RefreshTokenEntity();
                            return CacheHelper.toObject(refreshTokenEntity, JSON.parse(value));
                        }
                    }
                }
                case CacheSchemaType.APP_META_DATA: {
    ...
    var InteractionHandler = /** @class */ (function () {
        ...
        InteractionHandler.prototype.handleCodeResponse = function (locationHash) {
            return __awaiter(this, void 0, void 0, function () {
                var requestState, cachedNonceKey, cachedNonce, authCode, userState, tokenResponse;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            userState = ProtocolUtils.getUserRequestState(requestState);
                            return [4 /*yield*/, this.authModule.acquireToken(this.authCodeRequest, userState, cachedNonce)];
                        case 1:
    ...
    var RedirectHandler = /** @class */ (function (_super) {
         ...
         * @param urlNavigate
         */
        RedirectHandler.prototype.initiateAuthRequest = function (requestUrl, authCodeRequest, browserCrypto) {
            // Navigate if valid URL
            if (!StringUtils.isEmpty(requestUrl)) {
                // Set interaction status in the library.
                this.browserStorage.setItem(this.browserStorage.generateCacheKey(TemporaryCacheKeys.ORIGIN_URI), BrowserUtils.getCurrentUri(), CacheSchemaType.TEMPORARY);
    ...
    var PublicClientApplication = /** @class */ (function () {
        ...
        function PublicClientApplication(configuration) {
            ...
            this.defaultAuthorityInstance = AuthorityFactory.createInstance(this.config.auth.authority, this.config.system.networkClient);
            // This is temporary. Remove when ADFS is supported for browser
        ...
        PublicClientApplication.prototype.handleRedirectResponse = function () {
            return __awaiter(this, void 0, void 0, function () {
                var hash, cachedHash, isResponseHash, loginRequestUrl, currentUrl, hashKey;
                return __generator(this, function (_a) {
        ...
        PublicClientApplication.prototype.loginRedirect = function (request) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.acquireTokenRedirect(this.generateLoginRequest(request))];
                });
            });
        };
        /**
        ...
        PublicClientApplication.prototype.acquireTokenRedirect = function (request) {
            return __awaiter(this, void 0, void 0, function () {
                var validRequest, authCodeRequest, interactionHandler, navigateUrl, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            validRequest = this.preflightRequest(request);
                            return [4 /*yield*/, this.generateAuthorizationCodeRequest(validRequest)];
                        case 1:
                            authCodeRequest = _a.sent();
                            interactionHandler = new RedirectHandler(this.authModule, this.browserStorage);
                            return [4 /*yield*/, this.authModule.createUrl(validRequest)];
                        case 2:
                            navigateUrl = _a.sent();
        ...
        PublicClientApplication.prototype.loginPopup = function (request) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.acquireTokenPopup(this.generateLoginRequest(request))];
                });
            });
        };
        /**
        ...
        PublicClientApplication.prototype.acquireTokenPopup = function (request) {
            return __awaiter(this, void 0, void 0, function () {
                var validRequest, authCodeRequest, navigateUrl, e_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 4, , 5]);
                        ...
                        case 2:
                            navigateUrl = _a.sent();
                            return [4 /*yield*/, this.popupTokenHelper(navigateUrl, authCodeRequest)];
                        case 3: 
         ...
         * @param navigateUrl
         */
        PublicClientApplication.prototype.popupTokenHelper = function (navigateUrl, authCodeRequest) {
            return __awaiter(this, void 0, void 0, function () {
        ...
        PublicClientApplication.prototype.ssoSilent = function (request) {
            return __awaiter(this, void 0, void 0, function () {
                var silentRequest, authCodeRequest, scopeString, navigateUrl;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            silentRequest = this.initializeRequest(__assign(__assign({}, request), { prompt: PromptValue.NONE }));
                            return [4 /*yield*/, this.generateAuthorizationCodeRequest(silentRequest)];
                        case 1:
                            authCodeRequest = _a.sent();
                            scopeString = silentRequest.scopes ? silentRequest.scopes.join(" ") : "";
                            return [4 /*yield*/, this.authModule.createUrl(silentRequest)];
                        case 2:
                            navigateUrl = _a.sent();
                            return [2 /*return*/, this.silentTokenHelper(navigateUrl, authCodeRequest, scopeString)];
                    }
                });
            });
        };
        ...
        PublicClientApplication.prototype.acquireTokenSilent = function (silentRequest) {
            return __awaiter(this, void 0, void 0, function () {
                var e_3, isServerError, isInteractionRequiredError, isInvalidGrantError, silentAuthUrlRequest, authCodeRequest, navigateUrl, scopeString;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            // block the reload if it occurred inside a hidden iframe
                        ...
                        case 3:
                            ...
                            silentAuthUrlRequest = this.initializeRequest(__assign(__assign({}, silentRequest), { redirectUri: "", prompt: PromptValue.NONE }));
                            return [4 /*yield*/, this.generateAuthorizationCodeRequest(silentAuthUrlRequest)];
                        case 4:
                            authCodeRequest = _a.sent();
                            return [4 /*yield*/, this.authModule.createUrl(silentAuthUrlRequest)];
                        case 5:
                            navigateUrl = _a.sent();
                            scopeString = silentRequest.scopes ? silentRequest.scopes.join(" ") : "";
                            return [2 /*return*/, this.silentTokenHelper(navigateUrl, authCodeRequest, scopeString)];
         ...
         * @param userRequestScopes
         */
        PublicClientApplication.prototype.silentTokenHelper = function (navigateUrl, authCodeRequest, userRequestScopes) {
            return __awaiter(this, void 0, void 0, function () {
         ...
         * Default behaviour is to redirect the user to `window.location.href`.
         */
        PublicClientApplication.prototype.logout = function (account, authorityString) {
            var authorityObj = StringUtils.isEmpty(authorityString) ? this.defaultAuthorityInstance : AuthorityFactory.createInstance(this.config.auth.authority, this.config.system.networkClient);
            // create logout string and navigate user window to logout. Auth module will clear cache.
            this.authModule.logout(account, authorityObj).then(function (logoutUri) {
         ...
         * @param request
         */
        PublicClientApplication.prototype.generateLoginRequest = function (request) {
            var loginRequest = __assign({}, request);
         ...
         */
        PublicClientApplication.prototype.preflightRequest = function (request) {
            // block the reload if it occurred inside a hidden iframe
            BrowserUtils.blockReloadInHiddenIframes();
         ...
         * @param request
         */
        PublicClientApplication.prototype.initializeRequest = function (request) {
            ...
            validatedRequest.state = ProtocolUtils.setRequestState((request && request.state) || "", this.browserCrypto.createNewGuid());
        ...
        PublicClientApplication.prototype.generateAuthorizationCodeRequest = function (request) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            authCodeRequest = __assign(__assign({}, request), { code: "", codeVerifier: generatedPkceParams.verifier });
